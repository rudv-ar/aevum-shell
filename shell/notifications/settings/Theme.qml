...
Singleton {
    ...
    // ── Primary ──────────────────────────────────────────────────────
    readonly property color primaryP0:   palette.primary?.[0]   ?? "transparent"
    readonly property color primaryP5:   palette.primary?.[5]   ?? "transparent"
    readonly property color primaryP10:  palette.primary?.[10]  ?? "transparent"
    readonly property color primaryP15:  palette.primary?.[15]  ?? "transparent"
    readonly property color primaryP20:  palette.primary?.[20]  ?? "transparent"
    readonly property color primaryP25:  palette.primary?.[25]  ?? "transparent"
    readonly property color primaryP30:  palette.primary?.[30]  ?? "transparent"
    readonly property color primaryP35:  palette.primary?.[35]  ?? "transparent"
    readonly property color primaryP40:  palette.primary?.[40]  ?? "transparent"
    readonly property color primaryP50:  palette.primary?.[50]  ?? "transparent"
    readonly property color primaryP60:  palette.primary?.[60]  ?? "transparent"
    readonly property color primaryP70:  palette.primary?.[70]  ?? "transparent"
    readonly property color primaryP80:  palette.primary?.[80]  ?? "transparent"
    readonly property color primaryP90:  palette.primary?.[90]  ?? "transparent"
    readonly property color primaryP95:  palette.primary?.[95]  ?? "transparent"
    readonly property color primaryP98:  palette.primary?.[98]  ?? "transparent"
    readonly property color primaryP99:  palette.primary?.[99]  ?? "transparent"
    readonly property color primaryP100: palette.primary?.[100] ?? "transparent"

    // ── Secondary ────────────────────────────────────────────────────
    readonly property color secondaryP0:   palette.secondary?.[0]   ?? "transparent"
    readonly property color secondaryP5:   palette.secondary?.[5]   ?? "transparent"
    readonly property color secondaryP10:  palette.secondary?.[10]  ?? "transparent"
    readonly property color secondaryP15:  palette.secondary?.[15]  ?? "transparent"
    readonly property color secondaryP20:  palette.secondary?.[20]  ?? "transparent"
    readonly property color secondaryP25:  palette.secondary?.[25]  ?? "transparent"
    readonly property color secondaryP30:  palette.secondary?.[30]  ?? "transparent"
    readonly property color secondaryP35:  palette.secondary?.[35]  ?? "transparent"
    readonly property color secondaryP40:  palette.secondary?.[40]  ?? "transparent"
    readonly property color secondaryP50:  palette.secondary?.[50]  ?? "transparent"
    readonly property color secondaryP60:  palette.secondary?.[60]  ?? "transparent"
    readonly property color secondaryP70:  palette.secondary?.[70]  ?? "transparent"
    readonly property color secondaryP80:  palette.secondary?.[80]  ?? "transparent"
    readonly property color secondaryP90:  palette.secondary?.[90]  ?? "transparent"
    readonly property color secondaryP95:  palette.secondary?.[95]  ?? "transparent"
    readonly property color secondaryP98:  palette.secondary?.[98]  ?? "transparent"
    readonly property color secondaryP99:  palette.secondary?.[99]  ?? "transparent"
    readonly property color secondaryP100: palette.secondary?.[100] ?? "transparent"

    // ── Tertiary ─────────────────────────────────────────────────────
    readonly property color tertiaryP0:   palette.tertiary?.[0]   ?? "transparent"
    readonly property color tertiaryP5:   palette.tertiary?.[5]   ?? "transparent"
    readonly property color tertiaryP10:  palette.tertiary?.[10]  ?? "transparent"
    readonly property color tertiaryP15:  palette.tertiary?.[15]  ?? "transparent"
    readonly property color tertiaryP20:  palette.tertiary?.[20]  ?? "transparent"
    readonly property color tertiaryP25:  palette.tertiary?.[25]  ?? "transparent"
    readonly property color tertiaryP30:  palette.tertiary?.[30]  ?? "transparent"
    readonly property color tertiaryP35:  palette.tertiary?.[35]  ?? "transparent"
    readonly property color tertiaryP40:  palette.tertiary?.[40]  ?? "transparent"
    readonly property color tertiaryP50:  palette.tertiary?.[50]  ?? "transparent"
    readonly property color tertiaryP60:  palette.tertiary?.[60]  ?? "transparent"
    readonly property color tertiaryP70:  palette.tertiary?.[70]  ?? "transparent"
    readonly property color tertiaryP80:  palette.tertiary?.[80]  ?? "transparent"
    readonly property color tertiaryP90:  palette.tertiary?.[90]  ?? "transparent"
    readonly property color tertiaryP95:  palette.tertiary?.[95]  ?? "transparent"
    readonly property color tertiaryP98:  palette.tertiary?.[98]  ?? "transparent"
    readonly property color tertiaryP99:  palette.tertiary?.[99]  ?? "transparent"
    readonly property color tertiaryP100: palette.tertiary?.[100] ?? "transparent"

    // ── Neutral ──────────────────────────────────────────────────────
    readonly property color neutralP0:   palette.neutral?.[0]   ?? "transparent"
    readonly property color neutralP5:   palette.neutral?.[5]   ?? "transparent"
    readonly property color neutralP10:  palette.neutral?.[10]  ?? "transparent"
    readonly property color neutralP15:  palette.neutral?.[15]  ?? "transparent"
    readonly property color neutralP20:  palette.neutral?.[20]  ?? "transparent"
    readonly property color neutralP25:  palette.neutral?.[25]  ?? "transparent"
    readonly property color neutralP30:  palette.neutral?.[30]  ?? "transparent"
    readonly property color neutralP35:  palette.neutral?.[35]  ?? "transparent"
    readonly property color neutralP40:  palette.neutral?.[40]  ?? "transparent"
    readonly property color neutralP50:  palette.neutral?.[50]  ?? "transparent"
    readonly property color neutralP60:  palette.neutral?.[60]  ?? "transparent"
    readonly property color neutralP70:  palette.neutral?.[70]  ?? "transparent"
    readonly property color neutralP80:  palette.neutral?.[80]  ?? "transparent"
    readonly property color neutralP90:  palette.neutral?.[90]  ?? "transparent"
    readonly property color neutralP95:  palette.neutral?.[95]  ?? "transparent"
    readonly property color neutralP98:  palette.neutral?.[98]  ?? "transparent"
    readonly property color neutralP99:  palette.neutral?.[99]  ?? "transparent"
    readonly property color neutralP100: palette.neutral?.[100] ?? "transparent"
